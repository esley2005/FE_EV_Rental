...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Giả lập gửi form — sau này bạn có thể kết nối API tại đây
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-10 space-y-10">
      ...
      <div className="text-center space-y-3">
        <h1 className="text-4xl font-bold text-gray-800">Liên hệ với EV Rental</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3 text-gray-600">
            ...
            <p><strong>Điện thoại:</strong> <a href="tel:0901234567" className="text-blue-600 hover:underline">090 123 4567</a></p>
            <p><strong>Email:</strong> <a href="mailto:contact@evrental.vn" className="text-blue-600 hover:underline">contact@evrental.vn</a></p>
        ...
        <form onSubmit={handleSubmit} className="bg-white p-8 rounded-xl shadow-md space-y-5">
          <h2 className="text-2xl font-semibold text-gray-700 mb-2">Gửi tin nhắn cho chúng tôi</h2>
