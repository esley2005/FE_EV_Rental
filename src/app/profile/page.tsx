...
export default function ProfilePage() {
        ...
        if (response.success && response.data) {
          ...
          try {
            ...
            if (citizenIdResponse.success && citizenIdResponse.data) {
              const citizenData = citizenIdResponse.data;
  ...
  const handleSubmitLicense = async (values: any) => {
    ...
    try {
      ...
      const response = hasLicense 
        ? await driverLicenseApi.update({ ...licenseData, id: 0 }) // TODO: get actual ID
  ...
  const handleSubmitCitizenId = async (values: any) => {
    ...
    try {
      ...
      const response = hasCitizenId
        ? await citizenIdApi.update({ ...citizenIdData, id: 0 }) // TODO: get actual ID
